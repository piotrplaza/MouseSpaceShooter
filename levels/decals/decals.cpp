...
namespace Levels
{
	...
	public:
		...
		void postSetup()
		{
			...
			staticDecorations.emplace(Shapes2D::CreateVerticesOfRectangle({ 0.0f, 0.0f }, { 0.5f * texture.loaded.getAspectRatio(), 0.5f }), CM::DynamicTexture(mainTextureId), Shapes2D::CreateTexCoordOfRectangle());
