...
namespace Components
{
	struct RenderingBuffers : ComponentBase
	{
		...
		BuffersColections<std::deque<Buffers::GenericBuffers>> staticOfflineBuffers;
		BuffersColections<std::unordered_map<ComponentId, Buffers::GenericBuffers>> dynamicOfflineBuffers;
