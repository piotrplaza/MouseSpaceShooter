...
namespace Shapes3D
{
	...
	RenderableDef& AddSphere(RenderableDef& renderableDef, float radius, int rings, int sectors, bool texCoords = false, std::function<glm::vec4(glm::vec3 normal)> colorF = nullptr, const glm::mat4& transform = glm::mat4(1.0f));
	RenderableDef& AddCross(RenderableDef& renderableDef, glm::vec3 columnHSize = { 0.1f, 0.5f, 0.1f }, glm::vec3 rowHSize = { 0.35f, 0.1f, 0.1f }, float rowYPos = 0.15f, const glm::mat4& transform = glm::mat4(1.0f));
